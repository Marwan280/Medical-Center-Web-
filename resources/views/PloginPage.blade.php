...
<html lang="en">
  <head>
    ...
    <title>Express Medical Lab - Login</title>
    <style>
      :root {
    ...
    <main class="login-wrapper">
      <section class="login-card" aria-labelledby="login-title">
        ...
        <header class="headline">
          ...
          <p>Access test results, appointments, and lab reports securely.</p>
        </header>

        <div id="globalError" class="global-error @error('phone') visible @enderror" role="alert">
          @error('phone'){{ $message }}@enderror
        </div>

        <form id="loginForm" method="post" action="{{ route('patient') }}" novalidate>
          @csrf
          <div class="field">
          ...
          <div class="form-meta">
            ...
            <a href="/patient/forget-pass" class="forgot-link">Forgot password?</a>
          </div>

          <button type="submit" class="submit-btn">
            <span>Login to Medical Lab</span>
        ...
        <p class="helper-text">
          Need help? <a href="#">Contact Express Medical Lab support</a>
        </p>
      </section>
    </main>
