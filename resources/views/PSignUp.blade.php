...
<html lang="en">
  <head>
    ...
    <title>Express Medical Lab - Sign Up</title>
    <style>
      :root {
      ...
      * {
      ...
      .checkbox-wrapper input:checked {
        ...
        box-shadow: 0 6px 14px rgba(30, 136, 229, 0.36);
      }
      ...
      .submit-btn {
        ...
        transition: transform 0.11s ease, box-shadow 0.11s ease,
          filter 0.12s ease, background 0.16s ease;
      }
      ...
      <div class="doodle doodle--dna">
        ...
        >
          <g
            ...
            stroke-linejoin="round"
          >
            <path d="M23 17C29 23 41 29 47 35C41 41 29 47 23 53" />
            <path d="M47 17C41 23 29 29 23 35C29 41 41 47 47 53" />
            <path d="M27 21H35" />
            <path d="M35 27H43" />
            <path d="M27 43H35" />
            <path d="M35 49H43" />
      ...
      <section class="login-card" aria-labelledby="signup-title">
        <div class="brand">
          ...
          <div class="brand-text">
            ...
            <div class="brand-subtitle">Secure patient access</div>
          </div>
        </div>

        <header class="headline">
          <h2 id="signup-title">Create Account</h2>
          <p>Create your profile to access reports and appointments securely.</p>
        </header>
        ...
        <form id="signupForm" novalidate>
          ...
          <div class="form-meta">
            ...
            <a href="#" class="forgot-link">Terms</a>
          </div>
        ...
        <p class="helper-text">
          Already have an account? <a href="PloginPage.html">Login</a>
        </p>
      </section>
    </main>
    ...
    <script>
      (function () {
        ...
        function setLoading(isLoading) {
          ...
          submitText.textContent = isLoading ? "Creating account..." : "Sign Up";
        }
        ...
        form.addEventListener("submit", function (e) {
          ...
          setTimeout(function () {
            setLoading(false);
            globalSuccess.textContent = "Account created successfully!";
            globalSuccess.classList.add("visible");
            form.reset();
          }, 1000);
        });

        fullNameInput.addEventListener("input", clearErrors);
        emailInput.addEventListener("input", clearErrors);
        passwordInput.addEventListener("input", clearErrors);
        confirmPasswordInput.addEventListener("input", clearErrors);
        agreeTermsInput.addEventListener("change", clearErrors);
